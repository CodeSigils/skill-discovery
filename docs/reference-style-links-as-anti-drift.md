...
Zero-dependency [GFM](https://github.github.com/gfm/) and MDX formatter...

Align [GFM](https://github.github.com/gfm/) table columns...

empty cells per [GFM](https://github.github.com/gfm/)...
```

**Each of these is a drift surface.** If the URL changes, every occurrence
must be found and updated. Agents searching for `something.github.com/gfm/`
to refactor it will only catch the literal string — any variance breaks the
find.
